<div class="builder-component" data-type="image" data-id="{{ $id }}">
    ...
    <div class="mb-3">
        <img src="https://via.placeholder.com/800x400?text=Image+Placeholder" class="img-fluid rounded" alt="Placeholder image">
    </div>
</div>
