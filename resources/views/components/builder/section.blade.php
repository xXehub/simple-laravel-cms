<div class="builder-component" data-type="section" data-id="{{ $id }}">
    ...
    <section class="py-5 bg-light">
        <div class="container">
            <p class="text-muted mb-0">Section content goes here. This is a full-width section with container inside.</p>
        </div>
    </section>
</div>
