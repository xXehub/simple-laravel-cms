...
@php
    // Get menus from parameter or fetch from model
    $menus = $menus ?? \App\Models\MasterMenu::getSidebarMenus();
@endphp
    ...
    <div class="container-fluid">
        ...
        <div class="navbar-nav flex-row d-lg-none">
            <div class="d-none d-lg-flex me-3">
                <div class="btn-list">
                    <a href="https://github.com/tabler/tabler" class="btn btn-outline-white btn-sm" target="_blank"
                        rel="noreferrer">
                    ...
                    <a href="https://github.com/sponsors/codecalm" class="btn btn-outline-white btn-sm" target="_blank"
                        rel="noreferrer">
            ...
            <div class="d-none d-lg-flex">
                ...
                <div class="nav-item dropdown d-none d-md-flex me-3">
                    ...
                    <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-end dropdown-menu-card">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Get new add-ons</h3>
                            </div>
                            <div class="card-body">Get new add-ons and extend your dashboard with 3rd party plugins.
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link d-flex lh-1 p-0 px-2" data-bs-toggle="dropdown"
                    ...
                    <div class="d-none d-xl-block ps-2">
                        ...
                        <div class="mt-1 small text-secondary">{{ Auth::user()->roles->first()->name ?? 'No Role' }}
                        </div>
                    </div>
                </a>
        ...
        <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
                @forelse($menus as $menu)
                    <x-layout.sidebar-menu :menu="$menu" />
                @empty
                    <li class="nav-item">
