...
window.showConfirmationModal = function(options) {
    ...
    // Get or use the default confirmation modal
    const modal = document.getElementById(id) || document.getElementById('confirmationModal');
    if (!modal) {
    ...
    const titleElement = modal.querySelector('#confirmationTitle');
    const messageElement = modal.querySelector('#confirmationMessage');
    const detailsElement = modal.querySelector('#confirmationDetails');
    const itemNameElement = modal.querySelector('#confirmationItemName');
    const confirmBtn = modal.querySelector('#confirmationYesBtn');
    const cancelBtn = modal.querySelector('[data-bs-dismiss="modal"]');

    if (titleElement) titleElement.textContent = title;
    if (messageElement) messageElement.textContent = message;
    
    if (itemName && detailsElement && itemNameElement) {
    ...
    if (confirmBtn) {
        ...
        confirmBtn.className = `btn ${confirmClass} w-100`;
    }
