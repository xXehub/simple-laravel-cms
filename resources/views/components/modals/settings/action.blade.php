...
<div class="btn-list flex-nowrap">
    ...
    <button type="button" class="btn btn-sm btn-primary"style="padding: 4px 8px; font-size: 12px;" data-bs-toggle="modal" data-bs-target="#editSettingModal"
        onclick="editSetting({{ $setting->id }})" title="Edit Setting">
            <i class="fas fa-edit"></i>
        
    </button>

    <button type="button" class="btn btn-sm btn-danger" style="padding: 4px 8px; font-size: 12px;"
        onclick="confirmDeleteSetting({{ $setting->id }}, '{{ $setting->key }}')" title="Delete Setting">
