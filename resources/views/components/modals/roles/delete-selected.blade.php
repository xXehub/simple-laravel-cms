    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="deleteSelectedModalLabel">Delete Selected Roles</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <p>Are you sure you want to delete <strong id="delete-selected-count">0</strong> selected role(s)?</p>
                <p class="text-danger"><small>This action cannot be undone.</small></p>
                <div id="selected-roles-list" class="mt-2">
                    <!-- Selected roles will be listed here -->
                </div>
            </div>
