                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img class="img d-block mx-auto"
                                        src="{{ setting('landing_hero_image_1', '/static/illustrations/boy-with-key.svg') }}"
                                        alt="Hero Image 1" height="350"
                                        style="max-width: 100%; height: 350px; object-fit: contain;">
                                </div>
                                <div class="carousel-item">
                                    <img class="img d-block mx-auto"
                                        src="{{ setting('landing_hero_image_2', '/static/illustrations/boy-girl.svg') }}"
                                        alt="Hero Image 2" height="350"
                                        style="max-width: 100%; height: 350px; object-fit: contain;">
                                </div>
                                <div class="carousel-item">
                                    <img class="img d-block mx-auto"
                                        src="{{ setting('landing_hero_image_3', '/static/illustrations/growth.svg') }}"
            ...
            <div class="row items-center text-center g-4">
                ...
                <div class="col-md-6 col-lg-3 mb-4">
                    <a href="#" class="card bg-surface-secondary">
                        ...
                        <div class="img-responsive img-responsive-21x9 card-img-top"
                            style="background-image: url({{ setting('landing_card_1_image', './static/photos/home-office-desk-with-macbook-iphone-calendar-watch-and-organizer.jpg') }})">
                        </div>
                        <div class="card-body">
                            <h3 class="card-title">{{ setting('landing_card_1_title', 'Card with top image') }}</h3>
                ...
                <div class="col-md-6 col-lg-3 mb-4">
                    <a href="#" class="card bg-surface-secondary">
                        <!-- Photo -->
                        <div class="img-responsive img-responsive-21x9 card-img-top"
                            style="background-image: url({{ setting('landing_card_2_image', './static/photos/home-office-desk-with-macbook-iphone-calendar-watch-and-organizer.jpg') }})">
                        </div>
                        <div class="card-body">
                            <h3 class="card-title">{{ setting('landing_card_2_title', 'Card with top image') }}</h3>
                            <p class="text-secondary">
                ...
                <div class="col-md-6 col-lg-3 mb-4">
                    <a href="#" class="card bg-surface-secondary">
                        <!-- Photo -->
                        <div class="img-responsive img-responsive-21x9 card-img-top"
                            style="background-image: url({{ setting('landing_card_3_image', './static/photos/home-office-desk-with-macbook-iphone-calendar-watch-and-organizer.jpg') }})">
                        </div>
                        <div class="card-body">
                            <h3 class="card-title">{{ setting('landing_card_3_title', 'Card with top image') }}</h3>
                            <p class="text-secondary">
                ...
                <div class="col-md-6 col-lg-3 mb-4">
                    <a href="#" class="card bg-surface-secondary">
                        <!-- Photo -->
                        <div class="img-responsive img-responsive-21x9 card-img-top"
                            style="background-image: url({{ setting('landing_card_4_image', './static/photos/home-office-desk-with-macbook-iphone-calendar-watch-and-organizer.jpg') }})">
                        </div>
                        <div class="card-body">
                            <h3 class="card-title">{{ setting('landing_card_4_title', 'Card with top image') }}</h3>
                            <p class="text-secondary">
