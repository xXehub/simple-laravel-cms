...
document.addEventListener('DOMContentLoaded', function() {
    const PropertyEditor = {
        ...
        bindEvents() {
            ...
            // Editor controls - check if elements exist first
            ...
            if (resetBtn) {
                ...
                console.warn('Reset properties button not found');
            }
            
            if (applyBtn) {
                applyBtn.addEventListener('click', this.applyProperties.bind(this));
            } else {
                console.warn('Apply properties button not found');
            }
            
            if (applyCloseBtn) {
                applyCloseBtn.addEventListener('click', this.applyAndClose.bind(this));
            } else {
                console.warn('Apply and close button not found');
            }
        },
