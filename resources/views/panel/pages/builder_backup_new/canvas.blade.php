...
<div class="d-flex flex-column h-100">
            ...
            <div class="navbar-nav">
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="#" id="save-page">
                            <i class="ti ti-device-floppy me-2"></i>
                            Save
                        </a>
                        <a class="dropdown-item" href="#" id="preview-page">
    ...
    <!-- Canvas Area -->
    <div class="flex-fill overflow-auto p-3" style="background-color: #f8f9fa;">
        <div class="canvas-viewport mx-auto" id="canvas-viewport" data-view="desktop">
            <div class="canvas-content bg-white border rounded shadow-sm" id="canvas-content" style="min-height: 600px;">
                <!-- Drop Zone -->
...
<template id="canvas-component-template">
    <div class="canvas-component border rounded mb-3 position-relative" data-component-id="">
        <div class="component-wrapper">
            <div class="component-controls position-absolute top-0 end-0 translate-middle">
...
document.addEventListener('DOMContentLoaded', function() {
    const CanvasSystem = {
        ...
        getViewportClass(view) {
            switch(view) {
                case 'desktop': return 'w-100';
                case 'tablet': return 'w-75';
                case 'mobile': return 'w-50';
