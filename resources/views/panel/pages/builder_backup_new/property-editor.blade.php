...
<div class="d-flex flex-column h-100 border-start" style="width: 320px; display: none;" id="property-editor">>
    <!-- Editor Header -->
    <div class="navbar navbar-expand-md navbar-light border-bottom">
        <div class="container-fluid">
            ...
            <button class="btn btn-icon btn-sm" id="close-editor" title="Close Editor">
                <i class="ti ti-x"></i>
            </button>
        </div>
    </div>

    <!-- Editor Content with Sticky Scroll -->
    <div class="flex-fill overflow-auto" id="editor-content">
        <div class="empty">
    ...
    <div class="navbar border-top" id="editor-actions" style="display: none;">
        <div class="container-fluid">
            <div class="navbar-nav flex-row flex-fill">
                <div class="nav-item">
...
<template id="property-group-template">
    <div class="property-group">
        <div class="card">
            <div class="card-header cursor-pointer property-group-header" data-bs-toggle="collapse" data-bs-target=".property-group-content">
                <div class="d-flex align-items-center">
                    <h3 class="card-title property-group-title"></h3>
                    <div class="ms-auto">
