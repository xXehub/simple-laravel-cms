    ...
    <div class="p-3 border-bottom">
        <div class="mb-3">
            <div class="input-group">
                <input type="text" class="form-control form-control-sm" id="component-search" placeholder="Search components...">
                <button class="btn btn-outline-secondary btn-sm" id="clear-search" title="Clear search">
                    <i class="ti ti-x"></i>
                </button>
            </div>
        </div>
    ...
    <div class="component-category" data-category="">
        <div class="px-3 py-2 bg-light border-bottom sticky-top">
            <div class="d-flex align-items-center justify-content-between">
                <h6 class="mb-0 fw-bold text-muted category-name"></h6>
...
<template id="component-item-template">
    <div class="p-3 border-bottom component-item cursor-pointer" data-component-id="">
        <div class="d-flex align-items-center">
            <div class="avatar avatar-sm me-3 bg-light">
                <i class="ti ti-square text-primary"></i>
            </div>
            <div class="flex-grow-1 min-w-0">
                <div class="fw-medium component-name"></div>
                <small class="text-muted component-description"></small>
            </div>
            <div class="ms-2">
                <button class="btn btn-primary btn-sm add-component" title="Add to Canvas">
...
document.addEventListener('DOMContentLoaded', function() {
    const ComponentSidebar = {
        ...
        renderComponent(componentId, component) {
            ...
            icon.className = component.icon || 'ti ti-square text-primary';
