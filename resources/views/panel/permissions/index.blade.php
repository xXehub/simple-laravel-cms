                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-table">
                                <x-form.datatable-header searchPlaceholder="Cari permissions..." :showBulkDelete="true"
                                    bulkDeletePermission="delete-permissions" bulkDeleteText="Hapus Terpilih"
                                    :recordOptions="[10, 15, 25, 50, 100]" :defaultRecords="15" />
                                <div id="advanced-table">
                                    ...
                                    <div class="card-footer d-flex align-items-center">
                                        <div class="col-auto d-flex align-items-center">
                                            <p class="m-0 text-secondary" id="record-info">Menampilkan <strong>0 to
                                                    0</strong>
