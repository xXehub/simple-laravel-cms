<x-layout.app title="Permissions Management - Panel Admin" :use-sidebar="true">
                ...
                <div class="modal-content">
                    ...
                    <form method="POST" action="{{ route('panel.permissions.store') }}" id="createPermissionForm">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                <label for="create_name" class="form-label">Permission Name <span class="text-danger">*</span></label>
                            ...
                            <div class="mb-3">
                                ...
                                <small class="form-text text-muted">Optional: Group permissions for better organization</small>
                            </div>
                        </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form method="POST" action="{{ route('panel.permissions.update') }}" id="editPermissionForm">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                <label for="edit_name" class="form-label">Permission Name <span class="text-danger">*</span></label>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form method="POST" action="{{ route('panel.permissions.delete') }}" id="deletePermissionForm">
                        ...
                        <div class="modal-body">
                            <p>Are you sure you want to delete permission <strong id="delete_permission_name"></strong>?</p>
                            <p class="text-danger">This action cannot be undone and will remove this permission from all roles.</p>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
